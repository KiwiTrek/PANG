...
class ModuleLevelFive;
class ModuleLevelSix;
...
public:
    ...
    ModuleLevelFive* GetModuleLevelFive() const;
    ModuleLevelSix* GetModuleLevelSix() const;
...
private:
    ...
    ModuleLevelFive* levelFive = nullptr;
    ModuleLevelSix* levelSix = nullptr;
